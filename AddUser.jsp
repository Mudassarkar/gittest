...
<body>
       ...
       <div class="row">
                ...
                <div class="row">
					...
					<div class="card-body" style="background: linear-gradient(to bottom left, gray, transparent);">
                            <form action="../AddUser_Action" method="post"  style="margin-left: 120px; text-align: center">
                             <fieldset class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Full Name" maxlength="30" name="name"  onkeypress="return alphaOnly(event);" 
                                            style="text-transform:uppercase;" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-2"><label for="num"></label></div>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="PHONE NO. "name="contact" maxlength="10"  onblur="validateContact()" onkeypress="return isNumberKey(event);" required>
                                        </div>
                                     </div>   
                                   <div class="form-group row">
                                        <div class="col-sm-2"><label for="email"></label></div>
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control" id="UserEmail" placeholder="EMAIL" name="email" onkeyup="ValidateEmail()" required>
                                            <span id="lblError" style="color: red"></span>
                                            
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <div class="col-sm-2"><label for="aliesname"></label></div>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="aliesname" placeholder="Alies Name" maxlength="10" onkeypress="return alphaOnly(event)" 
                                            style="text-transform:uppercase" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                         <div class="col-sm-2"><label for="role"></label></div>
                                         <div class="col-sm-8">
                                    ...
                                    <div class="card-body">
                                       <button class="btn btn-success btn-md" style="border-radius: 12px" type="submit">Submit</button>
                                       <button class="btn btn-warning btn-md" style="border-radius: 12px; margin-left: 30px" type="reset" class="btn btn-primary" value="Reset">Reset</button>
              ...
              <%    				 		 
				...
				String uname , urole;
             	...
             	<tr>
             		...
             		<td>
             		<button type="button" class="btn btn-danger btn-xs mdi mdi-delete-forever"  onclick="deleteUser(<%=obj.getUD_Id()%>,<%=uname%> ,<%=urole %>>);" data-toggle="modal" data-target="#deleteModal"></button>&nbsp;&nbsp;
             	    <button type="button" class="btn btn-success btn-xs mdi mdi-grease-pencil" onclick="updateUser(<%=obj.getUD_Id() %>);" data-toggle="modal" data-target="#updateModal"></button>
             	...
             	%>	
                     ...
                     <!--********Delete Modal view ********* -->
					<div class="modal del" id="deleteModal" role="dialog">
					
					</div>
	
					<!--**********end modal -->	
					 <!--********Update Modal view ********* -->
					<div class="modal UpdateModalContent" id="updateModal" role="dialog">
    ...
    <script>
        ...
        function deleteUser(pid ,uname ,urole){
			
			 $.ajax({
		 		type: "POST",
		 		url: "../DeleteByIdUser",
		 		data: { PID : pid , Name=uname, Role=urole},
